...
public class ShopSettingsMenu extends AbstractMenu<ExcellentShop> {
            ...
            if (type instanceof MenuItemType type2) {
                ...
                switch (type2) {
                    ...
                    case SHOP_CHANGE_TYPE ->
                        shop.setType(CollectionsUtil.next(shop.getType(), shopType -> shopType.hasPermission(player)));
                    case SHOP_BANK -> {
    ...
    public @NotNull ShopProductsMenu getProductsMenu() {
        if (this.productsMenu == null) {
    ...
    public @NotNull ShopBankMenu getBankMenu() {
        if (this.bankMenu == null) {
