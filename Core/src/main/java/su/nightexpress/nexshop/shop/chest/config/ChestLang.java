...
public class ChestLang {
    ...
    public static final LangKey SHOP_ERROR_CURRENCY_INVALID = new LangKey("ChestShop.Shop.Error.Currency.Invalid", "<red>This currency is invalid or is not allowed!");
