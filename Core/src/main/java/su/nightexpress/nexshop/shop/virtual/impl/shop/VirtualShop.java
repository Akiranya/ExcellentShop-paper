...
public final class VirtualShop extends Shop<VirtualShop, VirtualProduct> implements ICleanable {
    ...
    public VirtualShop(@NotNull VirtualShopModule module, @NotNull JYML cfg, @NotNull String id) {
        ...
        this.placeholderMap
            .add(Placeholders.SHOP_BANK_BALANCE, () -> plugin.getCurrencyManager().getCurrencies()
                .stream()
                .map(currency -> currency.format(this.getBank().getBalance(currency)))
                .collect(Collectors.joining(", ")))
            .add(Placeholders.SHOP_VIRTUAL_DESCRIPTION, () -> String.join(", ", this.getDescription()))
    ...
    @Override
    protected @NotNull VirtualShop get() {
        return this;
    }

    public @NotNull VirtualShopModule getModule() {
        return module;
    }

    @Override
    public @NotNull VirtualShopView getView() {
        return this.view;
    }
    ...
    public @NotNull JYML getConfigProducts() {
    ...
    public @NotNull ShopMainEditor getEditor() {
        if (this.editor == null) {
    ...
    public @NotNull Set<VirtualDiscount> getDiscountConfigs() {
