...
public class ShopsListMenu extends AbstractMenuAuto<ExcellentShop, ChestShop> {
    ...
    @Override
    protected @NotNull List<ChestShop> getObjects(@NotNull Player player) {
        String user = this.others.get(player);
    ...
    @Override
    protected @NotNull ItemStack getObjectStack(@NotNull Player player, @NotNull ChestShop shop) {
    ...
    @Override
    protected @NotNull MenuClick getObjectClick(@NotNull Player player, @NotNull ChestShop shop) {
    ...
    public void onItemPrepare(@NotNull Player player, @NotNull MenuItem menuItem, @NotNull ItemStack item) {
        ...
        if (menuItem.getType() == Type.GLOBAL_MODE) {
            ItemUtil.replaceNameAndLore(item, str -> str.replace(PLACEHOLDER_GLOBAL, LangManager.getBoolean(this.isGlobalMode(player))));
        }
    }
