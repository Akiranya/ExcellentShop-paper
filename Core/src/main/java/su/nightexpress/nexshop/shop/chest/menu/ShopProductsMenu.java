...
public class ShopProductsMenu extends PlayerEditorMenu {
    ...
    public ShopProductsMenu(@NotNull ChestShop shop) {
        ...
        // Mewcraft start
        this.productName = cfg.getComponent("Products.Product.Name", Component.text(Placeholders.PRODUCT_PREVIEW_NAME));
        this.productLore = cfg.getComponentList("Products.Product.Lore");
        // Mewcraft end
