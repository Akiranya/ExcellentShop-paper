...
public class Lang extends EngineLang {
    ...
    public static final LangKey Module_Cmd_Reload = LangKey.of("Module.Cmd.Reload", "Module <green>%module%</green> reloaded!");

    public static final LangKey ERROR_CURRENCY_INVALID = LangKey.of("Error.Currency.Invalid", "<red>Invalid currency!");

    public static final LangKey EDITOR_GENERIC_ENTER_DAY      = LangKey.of("Editor.Generic.Enter.Day", "<gray>Enter <green>Day</green> in <green>English</green>");
    public static final LangKey EDITOR_GENERIC_ENTER_TIME     = LangKey.of("Editor.Generic.Enter.Time", "<gray>Enter <green>Time</green> like <green>18:00:00</green>");
    ...
    public static final LangKey EDITOR_PRODUCT_ENTER_PRICE    = LangKey.of("Editor.Product.Enter.Price", "<red>Enter new <green>price</green>");
    public static final LangKey EDITOR_PRODUCT_ENTER_CURRENCY = LangKey.of("Editor.Product.Enter.Currency", "<gray>Enter <green>currency id</green>");
    ...
    public static final LangKey SHOP_PRODUCT_ERROR_TOO_EXPENSIVE    = LangKey.of("Shop.Product.Error.TooExpensive", "{message: ~type: TITLES; ~fadeIn: 10; ~stay: 80; ~fadeOut: 10;}<red><l>Too Expensive! \n <gray>You need: <red>" + Placeholders.GENERIC_PRICE + "</red>!");
    public static final LangKey SHOP_PRODUCT_ERROR_NOT_ENOUGH_ITEMS = LangKey.of("Shop.Product.Error.NotEnoughItems", "{message: ~type: TITLES; ~fadeIn: 10; ~stay: 80; ~fadeOut: 10;}<red><l>Not Enough Items! \n <gray>You need: <red>x" + Placeholders.GENERIC_AMOUNT + " " + Placeholders.GENERIC_ITEM + "</red>!");
}
