...
public class ShopDataHandler extends AbstractUserDataHandler<ExcellentShop, ShopUser> {
    ...
    public static @NotNull ShopDataHandler getInstance(@NotNull ExcellentShop plugin) {
        if (INSTANCE == null) {
    ...
    @Override
    protected @NotNull List<SQLValue> getSaveColumns(@NotNull ShopUser shopUser) {
