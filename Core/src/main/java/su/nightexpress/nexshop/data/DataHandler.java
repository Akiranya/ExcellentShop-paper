...
public class DataHandler extends AbstractUserDataHandler<ExcellentShop, ShopUser> {
    ...
    public static @NotNull DataHandler getInstance(@NotNull ExcellentShop plugin) {
        if (INSTANCE == null) {
    ...
    @Override protected @NotNull List<SQLColumn> getExtraColumns() {
        return Collections.singletonList(COL_USER_SETTINGS);
    }

    @Override protected @NotNull List<SQLValue> getSaveColumns(@NotNull ShopUser shopUser) {
    ...
    @Override
    protected @NotNull Function<ResultSet, ShopUser> getFunctionToUser() {
    ...
    public @NotNull Function<ResultSet, ProductStockData> getFunctionStockData() {
        return funcStockData;
    }

    public @NotNull Function<ResultSet, ProductPriceData> getFunctionPriceData() {
        return funcPriceData;
    }

    public @NotNull List<ProductStockData> getProductStockData(@NotNull String holder) {
    ...
    public @NotNull List<ProductPriceData> getProductPriceData(@NotNull String shopId) {
