...
public class Perms {
    ...
    public static final JPermission VIRTUAL_COMMAND_SELL_MENU_OTHERS = new JPermission(PREFIX + "virtual.command.sellmenu.others", "Access to open the Sell Menu commands for other players.");
