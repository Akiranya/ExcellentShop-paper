...
public class Perms {
    ...
    public static final JPermission AUCTION_CURRENCY = new JPermission(PREFIX_AUCTION_CURRENCY + PlaceholderConstants.WILDCARD, "Allows to use all enabled currencies on Auction.", OP);
